...
function App() {
    ...
    const getPlatformIcon = (platform) => {
        switch (platform) {
            case 'Backend':
                return (
                    <svg viewBox="0 0 24 24" className="w-5 h-5 fill-indigo-500">
                        <path fillRule="evenodd" d="M3 5a2 2 0 012-2h14a2 2 0 012 2v4a2 2 0 01-2 2H5a2 2 0 01-2-2V5zm14 2a1 1 0 100-2 1 1 0 000 2zM5 15a2 2 0 012-2h14a2 2 0 012 2v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4zm14 2a1 1 0 100-2 1 1 0 000 2z" clipRule="evenodd" />
                    </svg>
                );
            case 'Android':
                return (
